...
//    protected static Board opponentBoard = new StandardBoard();
//    protected static Board playerBoard = new StandardBoard();
...
//
////        opponentBoard = new StandardBoard();
////        playerBoard.getBoard();
//
////        playerBoard =  new StandardBoard();
////        playerBoard.getBoard();
//
//        opponentBoard.getBoard();
//
////        playerBoard
//
//
//        playerBoard = new StandardBoardCreator(false, event -> {
//            if (inProgress) {
//                return;
//            }
//
...
//
//
//        VBox player = new VBox(playerBoard.getBoard());
//        VBox opponent = new VBox(opponentBoard.getBoard());
...
//        opponentBoard.getBoard().opponentPlayer.placeShipsOpponent(opponentBoard, new Random());
//        inProgress = true;
//    }
//
//    @Override
